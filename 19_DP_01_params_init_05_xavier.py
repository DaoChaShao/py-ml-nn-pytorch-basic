...
# -*- Coding: UTF-8 -*-
# @Time     :   2025/10/17 16:13
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   19_DP_01_params_init_05_xavier.py
# @Desc     :   
...
def main() -> None:
    """ Main Function """
    with Beautifier("Parameters Initialization with Xavier Initialization"):
        model = nn.Sequential(
            nn.Linear(10, 2),
        )
        ...
        for layer in model:
            if isinstance(layer, nn.Linear):
                ...
                # Xavier initialisation is typically not applied to biases because they are 1d tensors normally.
