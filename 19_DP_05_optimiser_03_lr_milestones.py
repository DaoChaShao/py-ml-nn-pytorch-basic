...
# -*- Coding: UTF-8 -*-
# @Time     :   2025/10/17 22:34
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   19_DP_05_optimiser_03_lr_milestones.py
# @Desc     :   
...
def train():
    with RandomSeed("Optimiser with Milestones Learning Rate Scheduler"):
        device = "cpu"
        ...
        scale: float = 0.7
        scheduler = optim.lr_scheduler.MultiStepLR(optimizer_sched, milestones=[30, 60, 90], gamma=scale)
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Optimiser with Milestones Learning Rate Scheduler")
        self.resize(800, 400)
        ...
        self._line_titles: list[str] = [
            "SGD Learning Rate",
            "SGD Function Output",
            "Milestones LR Scheduler Learning Rate",
            "Milestones LR Scheduler Function Output",
        ]
