...
# -*- Coding: UTF-8 -*-
# @Time     :   2025/10/17 22:39
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   19_DP_05_optimiser_04_lr_exponential.py
# @Desc     :   
...
def train():
    with RandomSeed("Optimiser with Exponential Learning Rate Scheduler"):
        device = "cpu"
        ...
        scale: float = 0.7
        scheduler = optim.lr_scheduler.ExponentialLR(optimizer_sched, gamma=scale)
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Optimiser with Exponential Learning Rate Scheduler")
        self.resize(800, 400)
