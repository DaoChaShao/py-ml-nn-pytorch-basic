...
# -*- Coding: UTF-8 -*-
# @Time     :   2025/10/17 22:47
# @Author   :   Shawn
# @Version  :   Version 0.1.0
# @File     :   19_DP_05_optimiser_05_lr_adagrad.py
# @Desc     :   
...
def train():
    with RandomSeed("Optimiser with AdaGrad Learning Rate Scheduler"):
        device = "cpu"
        ...
        params_ADA = X.clone().detach().requires_grad_(True)
        optimizer_ADA = optim.Adagrad([params_ADA], lr=ALPHA)
        ...
        # Forward pass
        alphas, outs_ADAM = grad_descent(params_ADA, optimizer_ADA, EPOCHS, BATCHES)
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Optimiser with AdaGrad Learning Rate Scheduler")
        self.resize(800, 400)
